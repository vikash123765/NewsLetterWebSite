...
{
    /// <inheritdoc />
    public partial class addedsubsciptionTypeIdInSubsciptionTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "nvarchar(23)", maxLength: 23, nullable: false),
                    Country = table.Column<string>(type: "nvarchar(69)", maxLength: 69, nullable: false),
                    StripeKey = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagDescription = table.Column<string>(type: "nvarchar(255)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentSummary = table.Column<string>(type: "nvarchar(350)", maxLength: 350, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SourceURL = table.Column<string>(type: "varchar(100)", nullable: false),
                    IsArchived = table.Column<bool>(type: "bit", nullable: false),
                    CommentsOnOff = table.Column<bool>(type: "bit", nullable: false),
                    Views = table.Column<int>(type: "int", nullable: false),
                    Likes = table.Column<int>(type: "int", nullable: false),
                    IsEditorsChoice = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgSourceURL = table.Column<string>(type: "varchar(100)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Local news and updates", 9.9900000000000002, "Local" },
                    { 2, "Sweden-specific news and updates", 14.99, "Sweden" },
                    { 3, "Global news and updates", 19.989999999999998, "World" },
                    { 4, "Weather forecasts and updates", 4.9900000000000002, "Weather" },
                    { 5, "Economic news and analysis", 12.99, "Economy" },
                    { 6, "Sport news and events", 7.9900000000000002, "Sport" }
                });
